    ...
    const Navbar = () => {
        ...
        return (
            <>
                <nav
                    className={`bg-white p-4 fixed w-full top-0 z-50 dark:bg-gray-900 transition-all duration-300 overflow-hidden ${isScrolled
                        ? 'shadow-lg backdrop-blur-lg bg-white/95 dark:bg-gray-900/95'
                        : 'shadow-lg'
                        }`}
                >
                ...
                <div
                    className={`fixed top-0 right-0 h-full w-80 bg-white dark:bg-gray-900 backdrop-blur-xl shadow-2xl z-50 transform transition-all duration-500 ease-out ${isMenuOpen ? "translate-x-0" : "translate-x-full"
                        ...
                        <div className="flex items-center justify-between mb-8 pb-4 border-b-2 border-gray-200 dark:border-gray-700">
                            <div className="flex items-center gap-3">
                                <div className="p-2 bg-blue-100 dark:bg-blue-900/50 rounded-lg">
                                    <i className="bx bx-store-alt text-2xl text-blue-600 dark:text-blue-400"></i>
                                </div>
                                    ...
                                    <li key={item.id}>
                                        ...
                                        >
                                            <div className="flex items-center gap-3 flex-1">
                                                <div className={`p-2 rounded-lg transition-all duration-300 ${isActive(item.id)
                                                    ? 'bg-white/20'
